...
sudo pacman -Syu --noconfirm bash-language-server curl firefox flatpak ghostty git github-cli helix shellcheck shfmt spotify taplo ttf-jetbrains-mono-nerd wget
